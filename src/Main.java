...
public class Main {
    ...
    public static void main(String[] args) {
        Map map = new Map("0");//initialize map
        ...
        System.out.println("/***********************");
        System.out.println("Nguyen Hoang Anh");
        System.out.println("This is the first prototype for Assignment1");
        System.out.println("/***********************");
        System.out.println();
        //Create objects:
        ...
        Road road_0 = new Road(Integer.toString(0), map, speedInput, new int[]{0, 0}, new int[]{lengthInput, 0});
        int[] start = new int[]{lengthInput, 0};
        ...
        int[] end = new int[]{lengthInput + road_0.getEndLocation()[0], 0};
        Road road_1 = new Road(Integer.toString(1), map, speedInput, start, end);
        map.connectRoadsOnMap(); // We have to connect all roads on the map
        ...
        System.out.print("Please enter the speed of the car in integer: ");
        speedInput = simController.nextInt();
        cars.get(0).setAssignedSpeed(speedInput);
        for (Car car : map.getCarsOnMap()) {
            car.printCarStatus();
        }
        ...
        cars.get(0).setAssignedSpeed(-negativeSpeed);
        ...
        System.out.println("First we change speed limit for 2 road to at least 2m/s");
        System.out.println("---------------------");
        for (Road road : roads) {
            if (road.getSpeedLimit() < 2) {
                road.setSpeedLimit(2);
            }
        }
        for (Road road : roads) {
            road.printRoadInfo();
